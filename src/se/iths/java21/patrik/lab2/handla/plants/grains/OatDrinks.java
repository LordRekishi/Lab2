...
public class OatDrinks extends PlantBased {
    public OatDrinks(String name, float price, float mass, String manufacturer, String origin, PlantType type, QualityClass quality, TasteAndSpice taste) {
