...
public class Smoothies extends AnimalBased {
    public Smoothies(String name, float price, float mass, String manufacturer, String origin, AnimalBasedType type, TasteAndSpice taste, float fatPercent) {
