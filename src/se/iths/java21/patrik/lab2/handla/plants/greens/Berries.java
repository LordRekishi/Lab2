...
public class Berries extends PlantBased {
    public Berries(String name, float price, float mass, String manufacturer, String origin, PlantType type, QualityClass quality, TasteAndSpice taste) {
